...
def signup():
    if request.method == 'POST':
        ...
        us_existe = False #Usuario.query.filter_by(nombre=usuario).first()
        email_existe = False #Usuario.query.filter_by(nombre=email).first()
...
def usuario():
    ...
    if request.method == 'POST':
        ...
        id_existe = False #Usuario.query.filter_by(id=id).first()
        dni_existe = False #Usuario.query.filter_by(dni=dni).first()
