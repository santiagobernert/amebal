...
import Tablero from "./components/cruds/Tablero-cruds";
    ...
    <div className="App">
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/crud/pagos" element={<PagosCRUD />} />
          <Route path="/crud/partidos" element={<PartidosCRUD />} />
          <Route path="/crud/torneos" element={<TorneosCRUD />} />
          <Route path="/crud" element={<Tablero />} />
        </Routes>
      </BrowserRouter>
